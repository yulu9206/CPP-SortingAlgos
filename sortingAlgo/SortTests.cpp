...
//    }
    if (sorted)
    {
        cout << setw(12) << sorter->get_copy_count();
        cout << setw(12) << sorter->get_destructor_count();
        cout << setw(12) << sorter->get_move_count();
        cout << setw(12) << sorter->get_compare_count();
        cout << setw(12) << sorter->get_elapsed_ms();
        cout << endl;
    }
    else
    {
